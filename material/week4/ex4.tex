...
after publishing.
\section{Migration} % 1
In what ways does the island model and the diffusion model handle migration differently?
With the population arranged into a grid of \(3\times5\) subpopulations,
how many iterations would at least be needed for a mutation in one corner of the grid to reach the corner at the opposite end with 4 neighbors (N,S,E,W) and with 8 neighbors (N,NE,E,SE,S,SW,W,NW)?

\section{Evolution strategy(ES)} % 2
\subsection{} % a
